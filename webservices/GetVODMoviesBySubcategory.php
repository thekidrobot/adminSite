...
$scid = escape_value($_GET['scid']);

$page = $_SERVER['HTTP_HOST'].$_SERVER['PHP_SELF'];
$page = 'http://'.substr($page,0,strrpos($page,"/"));

$soap_client = new nusoap_client($page.'/ws_GetVODMoviesBySubcategory.php?wsdl', true);
...
{
    $res = $soap_client->call('receiveUserData',array('userid' => $userid,'id' => $id,'scid' => $scid));
