...
<form name="formProceso" action="index.php" method="post" onSubmit="return validaAcceso()">
  <table width="912" border="0" align="center" cellpadding="0">
    ...
    <tr>
      ...
      <td width="531" valign="top"><span class="descripcion"><strong>Como funciona</strong><br>
        <br>
        Favor entrar em contato com a Franquia e registrar a sua <br>
unidade para ter acesso &agrave;s aulas via streaming</span></td>
    </tr>
