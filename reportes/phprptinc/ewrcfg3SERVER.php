...
define("EW_REPORT_CONN_HOST", "db2861.perfora.net", TRUE);
define("EW_REPORT_CONN_PORT", 3306, TRUE);
define("EW_REPORT_CONN_USER", "dbo361077786", TRUE);
define("EW_REPORT_CONN_PASS", "webtv123", TRUE);
define("EW_REPORT_CONN_DB", "db361077786", TRUE);
...
define("EW_REPORT_RANDOM_KEY", '9Psegq907x8Or_ri', TRUE); // Random key for encryption
...
define("EW_REPORT_PROJECT_NAME", "reportesRamp", TRUE); // Project Name
define("EW_REPORT_PROJECT_VAR", "reportesRamp", TRUE); // Project Name
