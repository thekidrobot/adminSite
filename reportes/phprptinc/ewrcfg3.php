...
define("EW_REPORT_CONN_HOST", "db2624.perfora.net", TRUE);
define("EW_REPORT_CONN_PORT", 3306, TRUE);
define("EW_REPORT_CONN_USER", "dbo341842064", TRUE);
define("EW_REPORT_CONN_PASS", "ramp123", TRUE);
define("EW_REPORT_CONN_DB", "db341842064", TRUE);
...
define("EW_REPORT_RANDOM_KEY", 'BSD4tp9DpeNwvlwi', TRUE); // Random key for encryption
...
define("EW_REPORT_PROJECT_NAME", "proyectoLfgrpr1", TRUE); // Project Name
define("EW_REPORT_PROJECT_VAR", "proyectoLfgrpr1", TRUE); // Project Name
