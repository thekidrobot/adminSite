	...
	<body>
		...
		<div id="containerHolder">
			<div id="container">
				...
				<div id="main">
					<h2><a href="#"><?=_("Reports")?></a> &raquo; <a href="#" class="active"><?=_("Reports by user - VOD Channels")?></a></h2>
					...
					<?php
						if($_POST['subscriber'])
						{
							...
							?><h3><?=_("Historic of videos for the user ")?><?=$subscriber_name?></h3><?
						?>
						<table>
						<thead>
							<tr>
						...
						<tbody>
							<?php
								...
								$sqlGet = "SELECT 
													...
													FROM 
														views_vodchannels vv, 
														vodchannels vc
													WHERE 
														vv.resource_id = vc.id AND 
														vv.subscriber_id = $subscriber_id 
													GROUP BY 
														resource_id";
								...
								while (!$rsGet->EOF)
								{
									...
									<tr <?php if($counter % 2) echo " class='odd'"?>>									
										<td class="gallery clearfix">
											<a href="graphs/viewsPerDateUserVod.php?uid=<?=$subscriber_id?>&vid=<?=$video_id?>&iframe=true&width=800&height=550" rel="prettyPhoto[details]" title="Views for the video <?=$video_name?>">
											<?=$rsGet->fields['name']?>
											</a>
										</td>
