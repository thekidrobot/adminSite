	...
	<body>
		...
		<div id="containerHolder">
			<div id="container">
				...
				<div id="main">
					<h2><a href="#"><?=_("Reports")?></a> &raquo; <a href="#" class="active"><?=_("Top $limit - VOD")?></a></h2>
								...
								while (!$rsGet->EOF)
								{
									...
									<tr <?php if($counter % 2) echo " class='odd'"?>>									
										<td class="gallery clearfix">
											<a href="graphs/viewsPerDateVodTop.php?vid=<?=$video_id?>&iframe=true&width=800&height=550" rel="prettyPhoto[details]" title="Views for the video <?=$video_name?>">
											<?=$rsGet->fields['name']?>
											</a>
										</td>
