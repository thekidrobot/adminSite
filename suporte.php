...
<form name="formProceso" action="index.php" method="post" onSubmit="return validaAcceso()">
  <table width="912" border="0" align="center" cellpadding="0">
    <tr>
      <th colspan="3" scope="col"><img src="imagenes/topo.jpg" alt="" width="900" height="174" border="0" usemap="#Map">
        <map name="Map">
    ...
    <tr>
      ...
      <td width="38"><p class="descripcion">&nbsp;</p>        </td>
      <td width="531" valign="top"><span class="descripcion"><strong>Suporte<br>
      </strong><br>
        Para suporte t&eacute;cnico entre em contato via <br>
        e-mail streaming@lfg.com.br ou via telefone (11) 2121-4803</span></td>
    </tr>
    
    <tr>
      <td colspan="3" bgcolor="#4E76B3">&nbsp;</td>
    </tr>
    <tr>
      <td colspan="3" bgcolor="#FFFFFF"><div align="center" class="descripcion_borde_inferior">&copy; Copyright 2009 LFG. all rights reserved. Powered   by <a href="http://www.ramprm.com" target="_blank">RAMP, LLC</a></div></td>
    </tr>
  </table>
  <br>
  <p>&nbsp;</p>
