	...
	<div id="containerHolder">
	 <div id="container">
		...
		<div id="main">
			...
			?>
		 <h2><a href="#"><?=_("User Management")?></a> &raquo; <a href="#" class="active"><?=_("Change your data")?></a></h2>
			...
			?>
				...
				<form action="<?=$currentPage?>" method="post" class="jNice"> 
					...
					<p>
						...
						<input type="text" name="username" value="<?=$rsGet->fields['username']?>" maxlength="100" class="text-long" readonly="readonly" />
					</p>
					<p>
