...
//echo "el usuario es " . $_POST['usuario'] . " y el grupo es  " . $_POST['grupo']; die();
...
<table width="340" border="0" cellpadding="0" cellspacing="0" class="borde_alrededor">
  <tr>
    <th colspan="3" class="encabezado" scope="col">Gerenciar o acesso</th>
  </tr>
  <tr>
  ...
  <?php
		 ...
		 {?>
                  <tr class="descripcion_borde_inferior">
                    ...
                    <td align="center" valign="middle" bgcolor="#CCCCCC" class="borde_derecho"><div class="fuente-verde" id="reg<?php echo $row['UGD_CONSECUTIVO']; ?>"><?php echo $row['UGD_DESCARGAS']; ?>&nbsp; 
                    ...
                    <td align="center" valign="top" bgcolor="#CCCCCC" class="borde_derecho"><?php echo $row['visitas']; ?></td>
                    <td valign="top" bgcolor="#CCCCCC" class="descripcion"> &nbsp; <?php echo $row['titulo']; ?></td>
...
<table width="340" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td height="21" align="right" bgcolor="#FFFFFF" class="descripcion_borde_inferior"><a href="#" class="descripcion" onclick="javascript:ocultarAdmin()">Fechar</a></td>
  </tr>
</table>
</body>
</html>