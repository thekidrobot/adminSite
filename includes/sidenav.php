<ul class="sideNav">
	<?php
		...
		if($currentPage == "reportsLive.php" or
		...
		if($role == 1)
		{
			...
			if($currentPage == "admins.php" or
				 $currentPage == "createAdmin.php" or 
				 $currentPage == "logs.php"
				 ) {
			?>
			<li><a href="admins.php" <?php if($currentPage == "admins.php") echo "class='active'"?> > <?=_("View Administrators")?></a></li>
			<li><a href="createAdmin.php" <?php if($currentPage == "createAdmin.php") echo "class='active'"?> > <?=_("Create Administrator")?></a></li>
			<li><a href="logs.php" <?php if($currentPage == "logs.php") echo "class='active'"?> > <?=_("Log Viewer")?></a></li>
			<?	
			}
			elseif($currentPage == "viewAdminDetail.php"){
				?>
				<li><a href="#" <?php if($currentPage == "viewAdminDetail.php") echo "class='active'"?> > <?=_("View Admin detail")?></a></li>
				<li><a href="admins.php" <?php if($currentPage == "admins.php") echo "class='active'"?> > <?=_("Back to the admin list")?></a></li>
				<?
			}
		}
		?>
